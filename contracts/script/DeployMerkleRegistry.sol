...
contract DeployMerkleRegistry is Script {
    function run() external {
        ...
        console.log("MerkleRootBlobRegistry deployed at:", address(merkleRegistry));
        ...
        string memory deploymentJson = string(abi.encodePacked(
            ...
            '  "owner": "', vm.toString(merkleRegistry.owner()), '",\n',
        ...
        console.log("Deployment addresses written to merkle-registry-deployment.json");
        ...
        console.log("1. Use updateMerkleRoot() with EIP-4844 blob transactions");
