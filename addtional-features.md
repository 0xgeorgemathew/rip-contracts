...
**Visual Elements**:
- Cost comparison bar chart (Traditional: $100 → Blobs: $10)
- Data flow diagram showing oracle → blob → smart contract
...
**AI Agent Instructions**: Create flow diagram showing Amazon → Extension → ZK generation → Blockchain, with data becoming encrypted/hidden after step 2.
...
**AI Agent Instructions**: Show circular flow of oracle checking prices → updating tree → storing in blob → updating chain.
...
**User Flow**:
1. **Purchase**: Amazon → Extension → Commitment → Policy
2. **Monitor**: Oracle → Merkle Tree → Blob Storage
3. **Claim**: Price Drop → ZK Proof → Payout
